...
<html>
  <head>
    <title>THE EMEREGENCY ALERT SYSTEM </title>
  ...
  <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
      <div id="container"> 
            <div class="header">
                ...
                <h5 style="color:#A52A2A;text-align:right;margin:0 0px 0px 0px; font-size:22px; font-family:elephant;"><i>...KILIFI COUNTY</i></h5>
             <hr /></div>
			   <ul id="saturday">
				    <?php
