            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <h1>ADD POLICE ON DUTY</h1>
                        <small>Police list</small>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="police_list.php"> 
                                            <i class="fa fa-list"></i> Check police List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                   <form method="post" action="police_register.php" id="loginForm"  >
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Username</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtusername">
                                <span class="help-block small">Your unique username to the system</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>First Name</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtfirstname">
                                <span class="help-block small">Your  FirstName</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>SecondName</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtlastname">
                                <span class="help-block small">Your  FirstName</span>
                            </div>
                           
                            <div class="form-group col-lg-6">
                                <label>County</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtcounty">
                                <span class="help-block small">Your County</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Age</label>
                                <input type="int" value="" id="username" required  class="form-control" name="txtage">
                                <span class="help-block small">Your Age</span>
                            </div>
                            <div class="form-group col-lg-6">
                                    <label>Date of Birth</label>
                                                <input name="txtdob" class="datepicker form-control hasDatepicker" type="date" placeholder="Dob">
                                                <span class="help-block small">Your  Date of Birth</span>
                                            </div>
                                     <div class="form-group col-lg-6">
                                                <label>Mobile</label>
                                 <input type="number"  class="form-control" placeholder="Enter Mobile" required  name="txtmobile">
                                            </div>
                                   <div class="form-group col-lg-6">
                                <label>Address</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtaddress">
                                <span class="help-block small">Your Address</span>
                            </div>
                                 </div>
                                   <div class="form-group col-lg-6">
                                <label>Rank</label>
                                <input type="text" value="" id="username" required  class="form-control" name="txtrank">
                                <span class="help-block small">Your Rank</span>
                            </div>
                            <div class="form-group col-lg-6">
