                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="hotline_list.php"> 
                                            <i class="fa fa-list"></i> Check Hotline Numbers List</a>  
                                        </div>
                                    </div>
                                     <div class="panel-body">
                                    <form method="post" action="hotline_register.php" id="loginForm"  >
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Hotline Number</label>
                                <input type="int" value="" id="username"  class="form-control" name="txthotline">
                                <span class="help-block small">Enter Hotline Number</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Hotline Category</label>
                                <input type="text" value="" id="username"  class="form-control" name="txttype">
                                <span class="help-block small">Enter Hotline Category</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Date</label>
