                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="accident_list.php"> 
                                            <i class="fa fa-list"></i> Check Accident List</a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                   <form method="post" action="accident_register.php" id="loginForm"  >
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Accident Location</label>
                                <input type="text" value="" id="username"  class="form-control" name="txtlocation">
                                <span class="help-block small">Enter Accident Location</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Accident Type</label>
                                <input type="text" value="" id="username"  class="form-control" name="txttype">
                                <span class="help-block small">Enter Accident type</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Date</label>
