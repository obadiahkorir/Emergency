...
<head>
    ...
    <title>KIBERENGE E-HEALTH SERVICES</title>

    
    <link rel="shortcut icon" href="assets/dist/img/ico/pwani.jpg" type="image/x-icon">
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="index-2.html" class="logo"> <!-- Logo -->
                    ...
                    <span class="logo-lg">
                        ...
                        <img src="assets/dist/img/pwani.jpg" alt="">
                    </span>
                </a>
          ...
          <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="image pull-left">
                            <img src="assets/dist/img/7.jpg" class="img-circle" alt="User Image">
                        </div>
                        <div class="info">
                            <h4>Welcome</h4>
                            <p>MR.OBADIAH</p>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2016-2017 <a href="#">Designed By Obadiah Korir</a>.</strong> All rights reserved.
            </footer>
