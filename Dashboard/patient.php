...
<body>
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "../images/logo.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">PWANI UNIVERSITY E-HEALTH</label>
			<?php
	...
	<div id = "content">
		...
		<?php require '../includes/add_patient.php'?>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Pwani University</label>
	</div>
