  ...
  <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
      <div id="container"> 
            <div class="header">
                ...
                <img style="margin:0px 0px 0px 0px;float:right;" src="images/logo.png" width="120" height="117" alt="Nigerian Logo"/>
                <h3 class="headtext"> &nbsp;<b>THE EMEREGECNY ALERT SYSTEM</b> </h3>
