                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="fire_list.php"> 
                                            <i class="fa fa-list"></i>  Check Fire List </a>  
                                        </div>
                                   <div class="panel-body">
                                   <form method="post" action="fire_register.php" id="loginForm"  >
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Fire Location</label>
                                <input type="text" value="" id="username"  class="form-control" name="txtlocation">
                                <span class="help-block small">Enter Fire Location</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Fire Type</label>
                                <input type="text" value="" id="username"  class="form-control" name="txttype">
                                <span class="help-block small">Enter Fire type</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Date</label>
