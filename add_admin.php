                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>CREAT NEW ADMINISTRATORS</h1>
                            <small>Administrators list</small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="admin_list.php"> 
                                            <i class="fa fa-list"></i> Check Administrators List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                   <form method="post" action="admin_save.php" id="loginForm"  >
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Username</label>
                                <input type="text" value="" id="username"  class="form-control" name="txtusername">
                                <span class="help-block small">Your unique username to the system</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>First Name</label>
                                <input type="text" value="" id="username"   class="form-control" name="txtfirstname">
                            ...
                            <div class="form-group col-lg-6">
                                <label>County</label>
                                <input type="text" value="" id="username"   class="form-control" name="txtcounty">
                                <span class="help-block small">Your County</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Age</label>
                                <input type="int" value="" id="username"   class="form-control" name="txtage">
                                <span class="help-block small">Your Age</span>
                            </div>
                            <div class="form-group col-lg-6">
                                    <label>Date of Birth</label>
                                                <input name="dob" class="datepicker form-control hasDatepicker" type="date" placeholder="">
                        ...
                        <div>
                            ...
                            <a class="btn btn-primary" href="inddex.php">Exit</a>
                        </div>
                    </form>
                </div>
                     </div>
