...
<head>
   ...
   <body class="hold-transition sidebar-mini">
    ...
    <?php
$update=$_GET['update'];
$result = mysqli_query($mysqli,"SELECT * FROM admin where id ='$update'");
?>
            ...
            <div class="panel-body">
                ...
                <form class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row['FirstName'];?>" placeholder="Enter First Name" required>
                    </div>
                    <div class="form-group">
...
<footer class="main-footer text-center">
    ...
    <strong>Copyright &copy; 2017-2018 <a href="#">Designed and Edited by Obadiah Korir</a>.</strong> All rights reserved.
</footer>
</div> <!-- ./wrapper -->
<!-- ./wrapper -->
        <!-- Start Core Plugins
