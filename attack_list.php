            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <h1>ADD NEW ATTACK INCIDENT</h1>
                        <small>Attack list</small>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="add_attack.php"> <i class="fa fa-plus"></i>Add Attack</a>  
                                    </div>
                              ...
                              <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    <thead class="success">
                                        ...
                                        $sql = "SELECT * FROM attack ORDER BY id";
                                       $result=mysqli_query($conn,"SELECT * FROM attack ORDER BY id"); 

                             while ($row=mysqli_fetch_array($result))
                            { ?><!--open of while -->
                            <tr>
                                <td><?php echo $row['id']; ?></td>
                                <td><?php echo $row['attacklocation']; ?></td>
                                <td><?php echo $row['date']; ?></td>
                                <td><?php echo $row['address']; ?></td>
                                <td><?php echo $row['mobile']; ?></td>
                                <td><?php echo $row['attackdescription']; ?></td>
                                ...
                                <td class="center"> 
                                    ...
                                    href="attack_delete.php?delID=<?php echo $row['id'];?>">
