                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="add_accident.php"> <i class="fa fa-plus"></i>Add Accident</a>  
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-4">
                                             ...
                                             <div class="dataTables_length">
                                                         <a ><img src="images/copy.png" alt="">
                                                             ...
                                                             <a><a href="accident_report.php"><img src="images/pdf.png" alt=""><span>PDF</span></a>
                              ...
                              <div class="table-responsive">
                                ...
                                <tr>
                                     <th>Serial No</th>
                                        ...
                                        $sql = "SELECT * FROM accident ORDER BY id";
                                       $result=mysqli_query($conn,"SELECT * FROM accident ORDER BY id"); 
                            ...
                            <tr>
                                ...
                                <td class="center"> 
                                    <a class="btn btn-info btn-xs" href="Edit_admin.php?uID=<?php echo $row['id']; ?>">
