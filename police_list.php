...
<?php
error_reporting(0);
$conn = mysqli_connect("localhost","root","","ehelp");
if(count($_POST)>0) {
$roll_no=$_POST[id];
$result = mysqli_query($conn,"SELECT * FROM police where id='$roll_no' ");
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <form action="police_list.php" method="get" class="sidebar-form search-box pull-right hidden-md hidden-lg hidden-sm">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                              ...
                              <div class="table-responsive">
                                ...
                                $result=mysqli_query($conn,"SELECT * FROM police ORDER BY id"); //rs.open sql,con
                            ...
                            <tr>
                                ...
                                <td class="center"> 
                                    ...
                                    href="data_delete.php?delID=<?php echo $row['id'];?>">
