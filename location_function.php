<?php
    ...
    ?>
    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCFi2UFYdPPfMi5-7K5n_KNNlrUrdWSQ5Y"></script> 
    ...
    var locations = [
        ...
        [
            'AMC Service',
            '<p><a href="accident_list.php">Fire Incident Here</a></p>',
